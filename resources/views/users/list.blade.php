    ...
    <x-app-layout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-4">
                ...
                @endif
                @can('user-create')
                    <a type="button" href="{{ route('users.create') }}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-3 mt-3 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Add User</a>
                @endcan
                            ...
                            @foreach ($data as $user)
                                ...
                                <tr class="border-b {{ $bgColor }} dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @can('user-edit')
                                            <a type="button" href="{{ route('users.edit',['id' => $user->id]) }}" class="text-white hover:cursor-pointer bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Edit</a>
                                        @endcan
